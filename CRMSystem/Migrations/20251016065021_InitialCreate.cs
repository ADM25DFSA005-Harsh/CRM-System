        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailHistory = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CallHistory = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerResponse", x => x.ResponseID);
                    table.ForeignKey(
                        name: "FK_CustomerResponse_Campaign_CampaignID",
                        column: x => x.CampaignID,
                        principalTable: "Campaign",
                        principalColumn: "CampaignID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerResponse_customerProfiles_CustomerID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedRep = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LeadId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesOpportunity", x => x.OpportunityID);
                    table.ForeignKey(
                        name: "FK_SalesOpportunity_Lead_LeadId",
                        column: x => x.LeadId,
                        principalTable: "Lead",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerResponse_CampaignID",
                table: "CustomerResponse",
                column: "CampaignID");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerResponse_CustomerID",
                table: "CustomerResponse",
                column: "CustomerID");

            migrationBuilder.CreateIndex(
                name: "IX_SalesOpportunity_LeadId",
